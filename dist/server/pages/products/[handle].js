...
const useProductPrice = ({ id , variantId  })=>{
    ...
    const { products , isLoading , isError , refetch  } = (0,medusa_react__WEBPACK_IMPORTED_MODULE_0__.useProducts)({
        id: id,
        cart_id: cart?.id
    }, {
...
var __webpack_exports__ = __webpack_require__.X(0, [676,664,675,571,809,300,688,338,594], () => (__webpack_exec__(584)));
